...
const Skills = () => {
  return (
    <div className="h-full bg-fixed" style={{backgroundImage: `linear-gradient(to right, rgba(13, 17, 55, 1), rgba(117, 19, 93, 1))`, fontFamily:"Architects Daughter"}}>
      ...
      <div className='animationFade text-center text-white font-semibold text-6xl pt-36 lg:pt-32 ' style={{textShadow: "4px 4px #0d1137"}}>
        My Skills
      </div>

      <div className='glass mt-20 w-full ml-auto mr-auto lg:w-1/2'>
      ...
      <div className="flex-center mt-5 flex-wrap">
